            ...
            <Container>
                <Flex>
                    ...
                    <div className="w-6/12 pl-28 mt-20 ">
                        ...
                        <div >
                           <Flex className='w-[795px] pt-20 pb-5 bg-headerBg rounded-2xl mt-40 ml-[-260px] z-0'>
                            <div className="w-[265px] text-center">
                                   <Headings className='font-pod text-6xl font-semibold ' headingsText='2010' />
                                   <Para className='text-3xl mt-3 font-medium relative after:absolute after:h-36 after:w-[2px] after:bg-black after:rounded-3xl after:right-0 after:top-[-84px]' paraText='Founded' />
                            </div>
                            <div className="w-[265px] text-center">
                                   <Headings className='font-pod text-6xl font-semibold ' headingsText='5000+' />
                                   <Para className='text-3xl mt-3 font-medium relative after:absolute after:h-36 after:w-[2px] after:bg-black after:rounded-3xl after:right-0 after:top-[-84px]' paraText='Product Sold' />
                            </div>
                            <div className="w-[265px] text-center">
